...
export const MagicBentoGrid = ({ className, children }) => {
  return (
    <div
      className={cn(
...
export const MagicBentoCard = ({
  ...
  >
    ...
    {cta && (
      ...
      >
        <button className="pointer-events-auto ml-auto flex items-center gap-2 text-sm font-bold text-neutral-700 dark:text-neutral-300">
          {cta}
